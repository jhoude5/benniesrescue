    ...
    <div>
        ...
        <div className='adoptions-template'>
            ...
            <div className="application-button">
              <a target='_blank' href="https://docs.google.com/forms/d/1qwbvGZIXm5UPopVmCOPcBpbSr6KSkhSBrtlTLSxRk3g"className="application-btn btn btn-primary btn-header">Soumettre une demande</a>
            </div>
            </div>
        </div>
