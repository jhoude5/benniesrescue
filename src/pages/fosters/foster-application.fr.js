...
const FosterApplication = () => {
  ...
  const handleSubmit = e => {
    ...
    fetch("/foster-application.fr.js", {
        method: "POST",
  ...
  return (
    <main>
      ...
      <div className="container">
            ...
            <form className='foster-application-form' name="foster-application-fr" method="post" data-netlify="true" data-netlify-honeypot="bot-field"
              onSubmit={handleSubmit} id="foster-application-fr">
                <input type="hidden" name="form-name" value="foster-application-fr" />
                ...
                <div className="row clearfix">
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Avez-vous 18 ans ou plus?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Êtes-vous propriétaire ou locataire de votre maison? <span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Si vous louez votre logement, le propriétaire du bien autorise-t-il l'accueil d'animaux ? <span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Est-ce que vous ou d’autres personnes fumez à l’intérieur de la maison ? <span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Possédez-vous actuellement des animaux de compagnie ?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Si vous possédez actuellement des animaux de compagnie, êtes-vous en mesure et disposé à isoler les animaux d'accueil des animaux de compagnie de la famille au sein du foyer, comme requis ? Cela comprend une période de quarantaine obligatoire de 7 jours pour les nouveaux animaux d'accueil.</legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Pouvez-vous garantir que les animaux présents dans le foyer d'accueil sont stérilisés, à jour de tous leurs vaccins et exempts de tout parasite ou maladie connu ?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Avez-vous accès à un moyen de transport ou êtes-vous en mesure d'informer Sauvetage Bennie's de toute assistance en matière de transport requise dès qu'elle est connue ?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='checkbox-option'>Partagez-vous actuellement un logement avec des personnes de moins de 18 ans ?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Partagez-vous actuellement un logement avec d’autres adultes ?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Les autres membres du foyer sont-ils conscients et acceptent-ils l’engagement qu’implique le fait d’être parent d’accueil ?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Y a-t-il des membres de la famille allergiques aux chats ?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Avez-vous ou prévoyez-vous acquérir un bac à litière, des bols de nourriture, une balance qui mesure les grammes et les onces/livres (comme une balance de cuisine) et un sac de transport pour animaux ?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='checkbox-option'>Vous souhaitez accueillir des chats adultes, des chats seniors, des chattes avec des chatons, des chatons qui ne sont plus avec leur mère, ou un ou plusieurs chats nécessitant des soins particuliers (socialisation ou soins médicaux) ?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Souhaitez-vous accueillir des animaux de façon indéfinie, pendant la « saison des chatons » ou seulement jusqu'à ce que vous trouviez un animal à adopter ?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Êtes-vous intéressé à accueillir des animaux à court terme (animaux nécessitant des traitements médicaux à court terme nécessitant une quarantaine, dans des situations d'urgence ou de nouveaux animaux admis nécessitant une quarantaine - normalement 2 à 3 semaines) ou êtes-vous intéressé à accueillir des animaux à long terme (de l'admission jusqu'à l'adoption - normalement 12 à 16 semaines) ?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Prévoyez-vous de créer les animaux) ou de les laisser se déplacer librement dans l'espace qui leur est désigné ?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Êtes-vous disposé et capable de socialiser et de dresser l'animal et d'informer Sauvetage Bennie's de tout problème de socialisation ou de comportement ?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Êtes-vous disposé et capable de fournir des soins médicaux de base à l’animal si celui-ci nécessite l’administration de médicaments ou d’autres soins médicaux particuliers recommandés par un vétérinaire ?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Êtes-vous disposé et capable de voir comment fournir des liquides sous-cutanés à l'animal ?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Êtes-vous disposé et capable de peser l'animal à l'aide d'une balance telle qu'une balance de cuisine) si Sauvetage Bennie's le demande ?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Accueillez-vous actuellement des animaux pour une autre organisation de sauvetage ou prévoyez-vous de le faire pendant la période où vous accueilleriez des animaux pour Sauvetage Bennie's?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Un membre du ménage a-t-il été reconnu coupable d’une violation de la loi sur le bien-être animal, comme la négligence, la cruauté ou l’abandon, ou de toute autre accusation liée au bien-être animal ?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Êtes-vous prêt et capable d'accueillir un animal en famille d'accueil chez vous avec un préavis de 48 heures ?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Comprenez-vous et reconnaissez-vous que Bennie's Rescue ne peut pas et ne donne aucune garantie quant à la santé, au tempérament, à la disposition mentale et à la formation des animaux sauvés, et que l'accueil d'animaux se fait à vos propres risques ?<span className='required'>*</span></legend>
