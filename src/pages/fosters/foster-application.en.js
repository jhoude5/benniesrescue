                ...
                <div className="row clearfix">
                    ...
                    <div className=" form-group">
                        ...
                        <label className='radio-label' for="yescats">Yes, cat(s)<input id="yescats" className='col-9 col-sm-10 col-md-11' onChange={({ target }) => setName(target.value)}
                          ...
                          type="radio" required name="otherpets" value={otherpets} minLength="3"  /></label>
                          <label className='radio-label' for="ownboth">Both cat(s) and dog(s)<input id="both" className='col-9 col-sm-10 col-md-11' onChange={({ target }) => setName(target.value)}
                          type="radio" required name="otherpets" value={otherpets} minLength="3"  /></label>
                    ...
                    <div className=" form-group">
                        ...
                        <label className='checkbox-label' for="childrenunderfive">Yes, I share a home with individual(s) under 5 years of age<input id="childrenunderfive" className='col-9 col-sm-10 col-md-11' onChange={({ target }) => setName(target.value)}
                    ...
                    <div className=" form-group">
                        ...
                        <label className='checkbox-label' for="typeadult">Adult cats<input id="typeadult" className='col-9 col-sm-10 col-md-11' onChange={({ target }) => setName(target.value)}
                          ...
                          <label className='checkbox-label' for="typesenior">Senior cats<input id="typesenior" className='col-9 col-sm-10 col-md-11' onChange={({ target }) => setName(target.value)}
                          type="checkbox" required name="type" value={type} minLength="3" /></label>
                    ...
                    <div className=" form-group">
                        ...
                        <input id="date" className='col-9 col-sm-10 col-md-3' onChange={({ target }) => setName(target.value)}
