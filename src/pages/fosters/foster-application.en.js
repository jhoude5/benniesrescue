...
const FosterApplication = () => {
  ...
  const handleSubmit = e => {
    ...
    fetch("/foster-application.en.js", {
        method: "POST",
  ...
  return (
    <main>
      <Header page='/fr/fosters/foster-application'/>
      <div className="container">
            ...
            <form className='foster-application-form' name="foster-application" method="post" data-netlify="true" data-netlify-honeypot="bot-field"
              onSubmit={handleSubmit} id="foster-application">
                <input type="hidden" name="form-name" value="foster-application" />
                ...
                <div className="row clearfix">
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Are you 18 years of age or older? <span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Do you own or rent your home? <span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>If you rent your home, does the owner of the property allow animal fostering? <span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Do you or any other individuals smoke inside the home? <span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Do you currently own any pets?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>If you currently own pets, are you able and willing to isolate foster animals from family pets within the home, as required? This includes a mandatory 7 day quarantine period for new fosters.</legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Can you ensure that existing animals in the foster home are spayed or neutered, are up to date on all vaccinations and are free of any known parasites or diseases?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Do you have access to transportation or are you able to advise Bennie's Rescue of any required transportation assistance as soon as it is known?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='checkbox-option'>Do you currently share a home with individuals under the age of 18?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Do you currently share a home with any other adults?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Are the other members of the household aware of and do they agree to the commitment involved with fostering?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Are any members of the household allergic to cats?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Do you have or do you plan on acquiring a litter box, food bowls, a scale that measures grams and ounces/pounds (such as a kitchen scale) and an animal carrier?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='checkbox-option'>Do you want to foster adult cats, senior cats, mother cats with kittens, kittens no longer with their mother, or cat(s) requiring special care (socialising or medical care)?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Do you want to foster animals indefinitely, during "kitten season" or only until you find an animal to adopt?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Are you interested in fostering animals short term (animals necessitating short-term medical treatments requiring quarantine, in emergency situations or new intake animals requiring quarantine - normally 2-3 weeks) or are you interested in fostering animals long term (from intake until adoption - normally 12-16 weeks)?</legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Do you plan on crating the animal(s) or allowing them to free roam in their designated space?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Are you willing and able to socialize and train the animal and advise Bennie's Rescue of any socialization or behavioral issues?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Are you willing and able to provide basic medical attention to the animal if the animal requires the administration of medications or other special medical attention as recommended by a veterinarian?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Are you willing and able to be shown how to provide sub cutaneous fluids to the animal?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Are you willing and able to weigh the animal using a scale such as a kitchen scale) if requested by Bennie's Rescue?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Do you currently foster animals for any other rescue organisation or do you plan to during the time period you would be fostering for Bennie's Rescue?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Has any member of the household been convicted of an animal welfare law violation such as neglect, cruelty or abandonment, or any other charge related to animal welfare?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Are you willing and able to take a foster animal into your home with 48 hours notice?<span className='required'>*</span></legend>
                    ...
                    <div className=" form-group">
                      <fieldset>
                        <legend className='radio-option'>Do you understand and acknowledge that Bennie's Rescue cannot and does not make any guarantees as to the health, temperament, mental disposition, and training of rescued animals, and that fostering animal(s) is at your own risk?<span className='required'>*</span></legend>
