              ...
              onSubmit={handleSubmit} id="adoption-application-form">
                ...
                <div className="row clearfix">
                    ...
                    <div className=" form-group">
                        ...
                        <label className='radio-label' for="homeyes">Yes<input id="homeyes" className='col-9 col-sm-10 col-md-11' onChange={({ target }) => setName(target.value)}
                          type="radio" required name="home" value={home} minLength="3" /></label>
                          <label className='radio-label' for="homeno">No<input id="homeno" className='col-9 col-sm-10 col-md-11' onChange={({ target }) => setName(target.value)}
                          type="radio" required name="home" value={home} minLength="3" /></label>
                    </div>
                    <div className=" form-group">
